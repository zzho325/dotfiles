...
- Review: `/codex https://github.com/example/repo/pull/25827`
...
```
orch review start https://github.com/example/repo/pull/25827
orch review list
...
If `notes.md` is missing, run `notes init` from the repo root before any other
notes command. `orch spawn` normally does this before the worker starts.
...
```
notes init               # create notes.md if missing
