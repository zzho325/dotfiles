...
func notesPath(custom string) string {
	if custom != "" {
		return custom
	}
	return "notes.md"
...
func cmdInit(path string) {
	...
	if err := os.WriteFile(path, []byte(initialNotes), 0o644); err != nil {
